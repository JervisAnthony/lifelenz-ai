...
export function AnalyticsOverview({ summary }: { summary: WellnessSummary }) {
  ...
  return (
    <section className="analytics-overview" aria-labelledby="analytics-overview-heading">
      <div className="analytics-overview__heading">
        ...
        <p>
          These counts describe the summary generated from your stored records. They are
      ...
      <p className="analytics-overview__note">
        A direction appears only when the summary API returns enough usable samples for
        that metric. Increasing, decreasing, and stable are mathematical descriptions.
      </p>
    </section>
  );
}
